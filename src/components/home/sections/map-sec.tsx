    ...
    return (
        <section className="px-4 py-20 bg-muted">
            <div className="max-w-6xl mx-auto">
                ...
                <Reveal delay={0.1}>
                    <div className="max-md:overflow-x-auto max-md:pb-4 max-md:-mx-4 max-md:px-4 scroll-disable">
                        <div
                            className="relative w-full h-115 max-md:w-[800px] rounded-3xl border-2 overflow-hidden map-dot-bg shrink-0"
                            style={{
                                borderColor: "#D9CFC0",
